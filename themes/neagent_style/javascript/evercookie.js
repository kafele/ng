loc_origin="http://neagent.by/";
loc_ec="http://neagent.by/files/ec/";
/*
...
this._evercookie = function(name, cb, value, i, dont_reset)
{
	...
	else
	{
		...
		{
			setTimeout(function() { self._evercookie(name, cb, value, i, dont_reset) }, 3000);
		}
...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = loc_ec + 'evercookie_cache.php?name=' + name;
	}
	else
	{
		...
		$.ajax({
			url: loc_ec + 'evercookie_cache.php?name=' + name,
...
this.evercookie_etag = function(name, value)
{
	...
	else
	{
		...
		$.ajax({
			url: loc_ec + 'evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF(loc_ec + "evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = loc_ec + 'evercookie_png.php?name=' + name;
		}
		else
		{
...
this.evercookie_silverlight = function(name, value) {
    ...
    */
        var source = loc_ec + "evercookie.xap";
