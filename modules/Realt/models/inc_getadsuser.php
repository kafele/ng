...
switch	($CI->uri->segment(4)){
 ...
 case 'all': case'allmy':case'userads':
$showtype="all";
...
if ($email=="") {	echo "не найдено  ";	return;	}
...
if ($allresults==0){
$str_add .= "Не найдено  объявлений этого пользователя";
...
$str_add .="<b> Показаны объявления  одного и того же автора. </b><br>";
...
//else{
$str_add .= $CI->parser->parse('realt_userad', $addata);
//}
