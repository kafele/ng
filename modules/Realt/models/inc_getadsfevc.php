...
$showtype="evc";
 ...
 $evc=$CI->uri->segment(5);
if ($evc=="") {	echo "не задан evc ";	return;	}
  break;
  ...
  $showtype="ip";
	$ip=$CI->uri->segment(5);
	if ($evc=="") {	echo "не задан ip ";	return;
  	}
	default:
...
if ($this->data['mlev']==4){
 echo  "1". $CI->uri->segment(1);
 echo  "2".$CI->uri->segment(2);
 echo  "3".$CI->uri->segment(3);
 echo  "4".$CI->uri->segment(4);
 echo  "5".$CI->uri->segment(5);
}
