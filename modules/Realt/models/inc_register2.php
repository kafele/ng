...
$CI->db->update("users");
						...
						{ $regerr .="Такой email уже зарегистрирован. Воспользуйтесь <a href='http://neagent.by/board/sendpassword'>восстановлением пароля</a>, если вы его забыли.";
					...
					{
					$regerr .="Такой email уже зарегистрирован. Воспользуйтесь <a href='http://neagent.by/board/sendpassword'>восстановлением пароля</a>, если вы его забыли!";
						$ci->usermanager_functions->additional_err['register'] = ( isset ($config['usermanager_email_as_username'])  &&  $config['usermanager_email_as_username'] == true) ? lang("module_usermanager_error_email_exists") : lang("module_usermanager_error_username_exists");
					}
...
$subject_letter = "Ваш пароль для доступа на neagent.by";
 
 
$message = $this->load->view('emails/ad_register_email2', $letterdata, true);
