...
$base_query=str_replace("&per_page=".$config['per_page'], "", $search_qs);
...
if ($this->data['wap_view']==1){
$addata['ad_mainpic']= str_replace("icon", "w_icon",  $addata['ad_mainpic']  );
}
...
break; 
case '1':case '3':case '5':case '7':case '9':case '11':case '13':default:
