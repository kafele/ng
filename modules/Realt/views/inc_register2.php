...
switch	($action){
case 'regstep1':  // регистрация новая. должно прийти письмо с паролем

$err="";
$email=$CI->input->post('email');
$pass=$CI->input->post('pass');
$regerr="";
if (!$pass ){  // если пароль не передан
$pass = generate_password(8);
$sendpassword=1; // тогда отправляем пароль
}
