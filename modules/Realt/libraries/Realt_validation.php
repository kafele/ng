...
class Realt_validation {
	 ...
	 *
	 */	
	function Realt_validation($rules = array())
	{	
...
if (substr( $str, 0,2)=='80'){$str="375" . substr (  $str , 2 );}
if (substr( $str, 0,3)=='375'  &&  strlen($str) == 12  ){
return TRUE;
} 
else{
return FALSE;
